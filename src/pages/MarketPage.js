...
class MarketPage extends React.Component {
  ...
  componentDidMount() {
    ...
    this.updateProductListener = API.graphql(graphqlOperation(onUpdateProduct)).subscribe({
      next: productData => {
        ...
        const updatedProductIndex = this.state.market.products.items.findIndex(item => item.id === updatedProduct.id);
    ...
    this.deletProductListener = API.graphql(graphqlOperation(onDeleteProduct)).subscribe({
      next: productData => {
  ...
  componentWillUnmount() {
    ...
    this.deletProductListener.unsubscribe();
  }
